...
<%@ include file="/WEB-INF/views/css-spinner.jsp"%>
...
<body>
	...
	<div class="container">
		<div class="col-md-6 col-md-offset-3">
			...
			<h4 class="form-signin-heading">Добавление новой задачи</h4>
			<c:url var="updateUrl" value="/task.add/${executor.id}" />
			<form:form id="taskForm" role="form" action="${updateUrl}"
				method="POST" commandName="taskDto">
				<div class="form-group">
					<label for="content" class="control-label">Содержание
						задачи:</label>
					<form:textarea class="form-control" id="content" path="content" />
					<form:errors path="content" element="div" cssClass="text-danger alert-danger"/>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="alertTimeDiv" class="control-label">Предупредить
						за:</label>
