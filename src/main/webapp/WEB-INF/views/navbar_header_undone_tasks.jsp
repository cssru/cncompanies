			...
			<ul class="nav navbar-nav navbar-right">
				<sec:authorize access="isAuthenticated()">
					...
					<sec:authorize access="hasRole('USER')">
						...
						<li class="active"><a
							href="<c:url value="/task.list/done/0" />">Мои выполненные
								задачи</a></li>
					</sec:authorize>
					...
					<sec:authorize
						...
						<c:if test="${showMyTasks}">
							<li class="active"><a href="<c:url value="/task.list/0" />">Мои
									задачи</a></li>

							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown">Задачи<b class="caret"></b></a>
								<ul class="dropdown-menu">
									<li><a href="<c:url value="/task.list/done/0" />">Мои
											выполненные задачи</a></li>
									<li><a href="<c:url value="/task.list/slave" />">Задачи
											подчиненных</a></li>
									<li><a href="<c:url value="/task.list/slave/done" />">Выполненные
											задачи подчиненных</a></li>
								</ul></li>
						</c:if>
						...
						<c:if test="${!showMyTasks}">
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown">Задачи<b class="caret"></b></a>
								<ul class="dropdown-menu">
									<li><a href="<c:url value="/task.list/0" />">Мои
											задачи</a></li>
									<li><a href="<c:url value="/task.list/done/0" />">Мои
											выполненные задачи</a></li>
									<li><a href="<c:url value="/task.list/slave" />">Задачи
