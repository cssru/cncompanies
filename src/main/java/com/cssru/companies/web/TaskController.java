...
import com.cssru.companies.ajax.AjaxEditRequest;
import com.cssru.companies.ajax.AjaxResponse;
import com.cssru.companies.ajax.AjaxResponseCodes;
import com.cssru.companies.domain.Employee;
import com.cssru.companies.domain.Task;
import com.cssru.companies.dto.TaskDto;
...
public class TaskController {
    ...
    public String archiveTask(@PathVariable("taskId") Long taskId,
        ...
        } else if ("slave-done".equals(redirect)) {
            return "redirect:/task.list/slave/done";
        }
        ...
        try {
            ...
            } else { // moved to archive -> show employee's tasks page
    ...
    public
    @ResponseBody
    AjaxResponse ajaxDeleteTask(@PathVariable("taskId") Long taskId) {
        Login managerLogin = loginChecker.getRegisteredLogin();
        try {
            loginChecker.checkLogin(managerLogin);
        } catch (BadLoginException ble) {
    ...
    public
    @ResponseBody
    AjaxResponse ajaxEditTask(@RequestBody AjaxEditRequest request) {
    ...
    public
    @ResponseBody
    SynchContainer<TaskJsonProxy> synchronizeHumans(@RequestBody SynchContainer<TaskJsonProxy> clientRequest) {
        Login managerLogin = loginChecker.getRegisteredLogin();
        try {
            loginChecker.checkLogin(managerLogin);
        } catch (BadLoginException ble) {
